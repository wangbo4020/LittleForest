...
package com.xsenlin.android.utils
...
object PermissionUtil {
    ...
    /*
         ...
         should be used: */// return Build.VERSION.SDK_INT == Build.VERSION_CODES.M
    fun isMNC(): Boolean =  Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
}
